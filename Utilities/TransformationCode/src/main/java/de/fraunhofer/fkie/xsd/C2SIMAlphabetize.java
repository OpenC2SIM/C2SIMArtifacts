...
//This is a slightly modified version to be used in the xsdCreator
//of Fraunhofer FKIE
 ...
 * 
 * @author JMPullen
 * @author of modifications for XsdCreator Michael Dembach
 */
public class C2SIMAlphabetize {
    ...
    //****************************************************//
    //****************************************************//
    //****This is the method, used for the xsdCreator.****//
    //****************************************************//
    //****************************************************//
    public Document alphabetize(Document doc){
        
        // copy and print the arguments
        System.out.println("Running C2SIMAlphabetize");
        
        
        //turns the doc into a string
        ...
        FileReader inputFile;
        FileWriter outputFile;
        inputXML = outputter.outputString(doc);
        ...
        InputStream inputStream = new ByteArrayInputStream(outputXML.getBytes(Charset.forName("UTF-8")));
        SAXEngine sax = new SAXBuilder();
        // write the output String to output file and close the file
        try{
        	

            Document doc2 = sax.build(inputStream);
            System.out.println("C2SIM alphabetizing completed");
            return doc2;
        }
        //In case of errors the original document is returned.
        catch(Exception e) {
            System.err.println(
                "Exception in writing XML file " + 
                    outputFilename + ":" + e.getMessage());
